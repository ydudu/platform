      ...
      <el-col :span="24">
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item label="地址">
            <el-cascader expand-trigger="hover" :options="options" v-model="formInline.user.address">
            </el-cascader>
          </el-form-item>
    ...
    export default {
      ...
      methods: {
        ...
        download: function() {
          ...
          str = encodeURIComponent(str); //encodeURIComponent()解决/n不换行问题
